...
const CreateQuizForm = () => {
  ...
  return (
    <div className="flex items-center justify-center mt-4 bg-card p-6 border border-gray-700/70 rounded-lg">
        ...
        <div className="w-full space-y-4 mt-4">
          ...
          <div>
            ...
            <textarea
              ...
              {...register("context")}
            />
            <p className="text-gray-500 text-sm mt-2">Providing context helps generate more relevant and specific questions</p>
