                ...
                [0, 1, 2, 3].map((quiz, index) =>
                    <div key={index} className='bg-card border border-gray-700/50 px-6 md:py-10 py-6 rounded-lg hover:border-header/70 space-y-4'>
                        ...
                        <div className='flex items-center gap-3'>
                            <Link href={"/quiz/1"} className='text-sm w-full font-medium text-center py-2 rounded-lg bg-black border border-gray-700/50 hover:bg-header/90 px-4 capitalize'>
                                View Results
                            </Link>
